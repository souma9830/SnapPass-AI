...
describe('ComplianceBreakdownCard export report callback', () => {
  const metrics = {
    ...
    status: 'COMPLIANT',
    checks: [
      { id: 'head_ratio', title: 'Head Ratio', passed: true, score: 95, recommendation: 'Keep current framing.' },
      { id: 'lighting', title: 'Lighting', passed: false, score: 60, recommendation: 'Use even lighting.' },
    ],
  };
