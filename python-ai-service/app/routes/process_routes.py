...
def remove_bg():
    ...
    try:
        ...
        advanced_hair_matting = request.form.get("advanced_hair_matting", "false").lower() == "true"
        result_bytes = remove_background(image_bytes, bg_colour, attire, advanced_hair_matting)
